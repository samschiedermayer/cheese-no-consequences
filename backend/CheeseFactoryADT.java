...
public interface CheeseFactoryADT {
	...
	/**
	 * Will return list of all milk weights and percentage milk weights for a given farm
	 * for a given year
	 * 
	 ...
	 * @return - an 12 long array of arrays of integers with [month][0] storing total weight,
	 * 			 and [month][1] storing percent total milk
	 */
	 ...
	 * @return - a HashMap with keys as a farm id String and values as a 2 length array that
